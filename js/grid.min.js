...
var Grid = function () {
    var $grid = $("#og-grid"), $items = $grid.children("li"), current = -1, previewPos = -1, scrollExtra = 0, marginExpanded = 10, $window = $(window), winsize, $body = $("html, body"), transEndEventNames = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "oTransitionEnd", msTransition: "MSTransitionEnd", transition: "transitionend"}, transEndEventName = transEndEventNames[Modernizr.prefixed("transition")], support = Modernizr.csstransitions, settings = {minHeight: 500, speed: 350, easing: "ease"};
    ...
    Preview.prototype = {create: function () {
        ...
        var $itemEl = this.$item.children("a"), eldata = {href: $itemEl.attr("href"), largesrc: $itemEl.data("largesrc"), title: $itemEl.data("title"), description: $itemEl.data("description")};
